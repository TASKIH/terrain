...
var language = __importStar(require("./language"));
var PriorityQueue = __importStar(require("js-priority-queue"));
// 乱数を生成する
...
function getTerritories(render) {
    ...
    var flux = getFlux(h);
    var terr = [];
    var queue = new PriorityQueue.default({ comparator: function (a, b) { return a.score - b.score; } });
    function weight(u, v) {
